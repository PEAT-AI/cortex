...
1. Check if eksctl iam polices changed by comparing the previous version of the eksctl policy docs to the new version's and update `./dev/minimum_aws_policy.json` and `docs/clusters/management/auth.md` accordingly. https://github.com/weaveworks/eksctl/blob/v0.206.0/userdocs/src/usage/minimum-iam-policies.md
...
1. `go get istio.io/client-go@v1.23.5 && go get istio.io/api@1.23.5`
